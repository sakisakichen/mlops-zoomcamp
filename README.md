...
The courses from [DataTalksClub](https://github.com/DataTalksClub/mlops-zoomcamp/blob/main/README.md)  
Objective is to have a understanding about practical aspects of productionizing ML services — from training and experimenting to model deployment and monitoring.  
6 modules indluded.  
